...
public class AchievementTest : BaseTestFactory
{
    public AchievementTest(WebApplicationFactory<Program> factory) : base(factory)
    {
    }


    [Theory]
    [InlineData("/api/Achievement/getList")] //listeleme işlemi başarılı sonuçlanırsa
    ...
    [InlineData("/api/Achievement/getList")]
    ...
    [Theory]
    [InlineData("/api/Achievement/getSingle")] //get single başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Achievement/getSingle")] // getsingle başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Achievement/add")] //ekleme işlemi başarılı sonuçlanırsa
...
{
  ""achievementName"": ""test_ile_eklendi"",
  ""goalName"": ""test_ile"",
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/Achievement/add")] //ekleme işlemi başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Achievement/update")] //update başarılı sonuçlanırsa
...
{
  ""id"": 4,
  ""achievementName"": ""test_ile_güncellendi"",
  ""goalName"": ""g44"",
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/Achievement/update")]
    ...
    [Theory]
    [InlineData("/api/Achievement/delete")] //delete başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Achievement/delete")] //delete başarısız sonuçlanırsa
