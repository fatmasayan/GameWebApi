...
public class UserOwendGarageTest : BaseTestFactory
{
    public UserOwendGarageTest(WebApplicationFactory<Program> factory) : base(factory)
    {
    }


    [Theory]
    [InlineData("/api/UserOwendGarage/getList")] //listeleme işlemi başarılı sonuçlanırsa
    ...
    [InlineData("/api/UserOwendGarage/getList")]
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/getSingle")] //get single başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/getSingle")] // getsingle başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/add")] //ekleme işlemi başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/add")] //ekleme işlemi başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/update")] //update başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/update")]
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/delete")] //delete başarılı sonuçlanırsa
    public async Task Delete_EndpointsReturnSuccess(string url)
    {
        _client.DefaultRequestHeaders.Add("Authorization", _token);
        var response = await _client.DeleteAsync(url + "/23");
    ...
    [Theory]
    [InlineData("/api/UserOwendGarage/delete")] //delete başarısız sonuçlanırsa
