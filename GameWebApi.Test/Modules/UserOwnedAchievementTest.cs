...
public class UserOwnedAchievementTest : BaseTestFactory
{
    public UserOwnedAchievementTest(WebApplicationFactory<Program> factory) : base(factory)
    {
    }


    [Theory]
    [InlineData("/api/UserOwnedAchievement/getList")] //listeleme işlemi başarılı sonuçlanırsa
    ...
    [InlineData("/api/UserOwnedAchievement/getList")]
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/getSingle")] //get single başarılı sonuçlanırsa
    public async Task Get_EndpointsReturnSuccess(string url)
    {
        _client.DefaultRequestHeaders.Add("Authorization", _token);
        var response = await _client.GetAsync(url + "/13");
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/getSingle")] // getsingle başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/add")] //ekleme işlemi başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/add")] //ekleme işlemi başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/update")] //update başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/update")]
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/delete")] //delete başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/UserOwnedAchievement/delete")] //delete başarısız sonuçlanırsa
