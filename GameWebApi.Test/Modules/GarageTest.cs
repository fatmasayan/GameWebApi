...
public class GarageTest : BaseTestFactory
{
    public GarageTest(WebApplicationFactory<Program> factory) : base(factory)
    {
    }


    [Theory]
    [InlineData("/api/Garage/getList")] //listeleme işlemi başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Garage/getSingle")] //get single başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Garage/getSingle")] // getsingle başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Garage/add")] //ekleme işlemi başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/Garage/add")] //ekleme işlemi başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Garage/update")] //update başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/Garage/delete")] //delete başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Garage/delete")] //delete başarısız sonuçlanırsa
