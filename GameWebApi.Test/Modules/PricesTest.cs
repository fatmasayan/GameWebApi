...
public class PricesTest : BaseTestFactory
{
    public PricesTest(WebApplicationFactory<Program> factory) : base(factory)
    {
    }


    [Theory]
    [InlineData("/api/Prices/getList")] //listeleme işlemi başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Prices/getSingle")] //get single başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Prices/getSingle")] // getsingle başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Prices/add")] //ekleme işlemi başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/Prices/add")] //ekleme işlemi başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/Prices/update")] //update başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/Prices/delete")] //delete başarılı sonuçlanırsa
    public async Task Delete_EndpointsReturnSuccess(string url)
    {
        _client.DefaultRequestHeaders.Add("Authorization", _token);
        var response = await _client.DeleteAsync(url + "/18");
    ...
    [Theory]
    [InlineData("/api/Prices/delete")] //delete başarısız sonuçlanırsa
