...
public class AuthGroupPermissionsTest : BaseTestFactory
{
    public AuthGroupPermissionsTest(WebApplicationFactory<Program> factory) : base(factory)
    {
    }

    [Theory]
    [InlineData("/api/AuthGroupPermissions/getList")] //listeleme işlemi başarılı sonuçlanırsa
    ...
    [InlineData("/api/AuthGroupPermissions/getList")]
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/getSingle")] //get single başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/getSingle")] // getsingle başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/add")] //ekleme işlemi başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/add")] //ekleme işlemi başarısız sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/update")] //update başarılı sonuçlanırsa
...
", Encoding.UTF8, "application/json"));
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/update")]
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/delete")] //delete başarılı sonuçlanırsa
    ...
    [Theory]
    [InlineData("/api/AuthGroupPermissions/delete")] //delete başarısız sonuçlanırsa
